...
NPM Modules Used at The Front-End:\_
-antd
-axios
-formik
-moment
...
Dev Dependencies Used(In Both Sides):\_
-eslint
-prettier
-nodemon(This ONLY IN THE BACK-END)
-http-proxy-middleware(This ONLY IN THE FRONT-END)
-babel-eslint
